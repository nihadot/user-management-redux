...
import { addUserFailure, addUserStart, addUserSuccess, fetchUserByIdFailure, fetchUserByIdStart, fetchUserByIdSuccess } from '../../../redux/slices/userSlice';
import AddUser from '../AddUse';
import { addUser, fetchUserById } from '../../../services/userApi';
    ...
    const fetchInitialData =async ()=>{
        ...
        try {
           ...
           console.log(result.data,'----')
            fetchUserByIdSuccess(result.data)
            setDefaultData(result.data)
        } catch (error) {
            fetchUserByIdFailure(error.message)
        }
    }
    fetchInitialData()
  },[])
